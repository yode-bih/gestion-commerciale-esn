...
const menuItems = [
  ...
  { icon: TrendingUp, label: "Atterrissage", path: "/landing" },
  { icon: BarChart3, label: "Simulation", path: "/simulation" },
  { icon: SlidersHorizontal, label: "Pondérations", path: "/weights", adminOnly: true },
  { icon: UserCheck, label: "Demandes", path: "/requests", adminOnly: true },
